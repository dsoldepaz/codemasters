...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <nav>
        <ul>
            ...
            <li class="item-navegacion"><a href="FormReporteCocina.aspx" title="Reportes" class="seleccionado">Reportes de cocina</a></li>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <asp:GridView ID="GridViewSnacks" Class="Gridcontenedor" runat="server" AllowPaging="true" OnPageIndexChanging="GridViewSnacks_PageIndexChanging" PageSize="5" Visible="true">
