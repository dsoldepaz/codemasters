...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="contenedor">
            ...
            <section id="ContenedorManejoDeHorario" runat="server" visible="false">
                    ...
                    <input type="button" class="btn btn-submmit" value="agregar fecha" runat="server" onserverclick="AgregarFecha_ServerClick"/>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                     <asp:GridView ID="GridFechasReservadas" Visible="false" runat="server" BorderColor="#CCCCCC" BorderStyle="Dotted" BorderWidth="2px" AutoGenerateDeleteButton="True">
